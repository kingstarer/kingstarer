...
bool CC_COM_<Common>::CC_<Common>( const <inparam>& data, <outparam>& res )
{
    LogHere();
    RecordFlow();
...
bool CC_COM_<Common>::setCallInfo(HRecvMsg *sendmsg, const <inparam>& data)
{
    LogHere();
...
bool CC_COM_<Common>::getCallResult(HSendMsg *rcvmsg, <outparam>& res)
{
    LogHere();
